...
{
    class HarborBuoy : DrawableEntity
    {
        #region Fields
        ...
        //[][Aukstyn][Atgal]
        private Vector3 position = new Vector3(400, -200, 400);
        ...
        public HarborBuoy(Game game) : base(game)
        {
        }
        ...
        public override void Initialize()
        {
            ...
            this.model = this.Game.Content.Load<Model>("HarborBuoy");
