    ...
    public class SkyProcessor : ContentProcessor<Texture2DContent, SkyContent>
    {
                                           ...
                                           ContentProcessorContext context)
        {
            ...
            for (int i = 0; i < cylinderSegments; i++)
            {
                ...
                topVertices.Add(builder.CreatePosition(x, 1, z));
                bottomVertices.Add(builder.CreatePosition(x, -1, z));
            }

            // Create two center vertices, used for closing the top and bottom.
            int topCenterVertex = builder.CreatePosition(0, 2, 0);
            int bottomCenterVertex = builder.CreatePosition(0, -2, 0);

            // Create a custom effect material,
            // and point it at our sky rendering effect file. The default ModelProcessor
            // will compile sky.fx for us.
